...
var SoccerAliases = map[string]string{
	...
	"juve stabia":    "stabia",
	"sudtirol":       "sudtirol bolzano",
	"fc sudtirol":    "sudtirol bolzano",
	...
	"est. rio cuarto": "rio cuarto",
	"estudiantes rio cuarto": "rio cuarto",
	...
	// Belgian Pro League
	"st. truiden":    "st. truidense",
	"sint-truiden":   "st. truidense",
	"royale union sg": "union gilloise",
	"union saint-gilloise": "union gilloise",
	...
	"sporting charleroi": "royal charleroi",
	...
	"al-qadsiah el-khobar": "al-qadsiah",
	"al shabab":      "al-shabab",
	...
	"termalica":      "nieciecza",
	"rakow czestochowa": "czestochowa",
	"rakow":          "czestochowa",

	// Goalserve/FIFA parenthetical suffixes (e.g. "Rangers (Leon)" -> "rangers")
	"rangers (leon)": "rangers",
	"paok (professor)": "paok",
	"aston villa (snail)": "aston villa",
	"fenerbahce (razvan)": "fenerbahce sk",
	"al ahli (dava)": "al-ahli",
	"al hilal (blackstar98)": "al-hilal",
	"juventus (wboy)": "juventus",
	"sassuolo (laikingdast)": "sassuolo",
	"france (bullfrog)": "france",
	"spain (butcher)": "spain",
	"tottenham (prophet)": "tottenham hotspur",
	"arsenal (alibi)": "arsenal",
	"gangwon fc (rossfcdk)": "gangwon fc",
	"fc seoul (meltosik)": "fc seoul",
	"czechia (trush99)": "czechia",
	"netherlands (stason23)": "netherlands",
	"portugal (vladl3n)": "portugal",
	"italy (kril)":   "italy",
	"napoli (kraftvk)": "ssc napoli",
	"bologna (bomb1to)": "bologna fc",

	// Kalshi pregame matching — alternate names for events with no Goalserve match
	"ec bahia":       "bahia",
	"bahia fc":       "bahia",
	...
	"lech":            "lech poznan",
	"ks lech poznan": "lech poznan",
	"kups":            "kuopion palloseura",
	"kuopion ps":     "kuopion palloseura",
	"al kholood":     "al-kholood",
	"yokohama marinos": "marinos",
	"tokyo verdy":    "tokyo v",
	"verdy":           "tokyo v",
	...
	"san jose earth quakes": "earthquakes",
	...
	"ind. bogota":    "internacional de bogota",
	"chelsea fc":     "chelsea",
	"burnley fc":     "burnley",
